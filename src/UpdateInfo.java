...
public class UpdateInfo extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent ae) {
		if(ae.getSource() == b1){
            ...
            try{
                conn c = new conn();
                c.s.executeUpdate("UPDATE customer SET address = '"+s3+"', district = '"+s4+"', postcode = '"+s5+"', email = '"+s6+"', phone = '"+s7+"' WHERE meter_number = '"+s2+"'");

...
//            
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == b1){
            String str = "SELECT * FROM bill_c WHERE meter_number = '"+c1.getSelectedItem()+"' AND month = '"+c2.getSelectedItem()+"'";
            try{
                conn c = new conn();

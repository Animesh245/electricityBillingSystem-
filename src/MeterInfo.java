...
public class MeterInfo extends JFrame implements ActionListener{
	...
	MeterInfo(String meter){
		...
		p.setBorder(new TitledBorder(new LineBorder(new Color(173, 216, 230),2),"METER INFORMATION", TitledBorder.LEADING,TitledBorder.TOP,null, new Color(173,216,230)));
		add(p, "Center");
